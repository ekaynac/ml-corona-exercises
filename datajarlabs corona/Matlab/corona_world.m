...
X = data(:, 2:39); y = data(:, 1);
m = height(y); % number of training examples

%% =================== Part 3: Cost and Gradient descent ===================

X = [ones(m, 1), data(:, 2:39)]; % Add a column of ones to x
theta = zeros(39, 1); % initialize fitting parameters
